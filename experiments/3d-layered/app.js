...
function tickIntro(nowMs) {
  ...
  const terr = introWindow(absT, 3.9, 5.4);
  const cross = introWindow(absT, 3.9, 5.4);
  ...
  const reveal = introWindow(absT, 3.9, 5.4) * 1.3;
  ...
  if (introState.paused === null && absT >= 5.4) finishIntro();
}
